...
The Microsoft Windows 11 STIG Profile uses the [InSpec](https://github.com/inspec/inspec)
...
Requirements associated with the Microsoft Windows 11 STIG are derived from the
...
The Microsoft Windows 11 STIG profile checks were developed to provide technical implementation
...
```yaml
  ...
  # used by the Microsoft Windows 11 STIG profile.
...
```bash
cd microsoft-windows-11-stig-baseline
git pull
cd ..
